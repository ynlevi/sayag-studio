const en = {
  about: {
    h1: "who am I",
    p: [
      "Hi, I'm Ofek, 25 years old from Jerusalem, a videographer, video editor, and creator.",
    ...
    Understanding and strategizing exactly what our customers need.`,
      "So what's in our studio?",

      "- Conceptual and creative meetings for any purpose.",
      "- Studio and on-location video shooting.",
  ...
  contact: {
    ...
    action: { hl: "Let's be in touch" },
  },
  footer: {
    a: "Made with ♡ by Yonathan Levi | © All rights reserved",
  },
  navbar: {
    photos: "Photos",
    videos: "Videos",
